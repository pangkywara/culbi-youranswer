...
export default function ReviewsSection({ rating, reviewCount, reviews, dbReviews }: ReviewsSectionProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        {reviewCount != null && (
          <TouchableOpacity style={styles.showAllBtn} activeOpacity={0.7}>
            <Text style={styles.showAllText}>Show all {reviewCount} reviews</Text>
          </TouchableOpacity>
        )}
      </View>
    </View>
